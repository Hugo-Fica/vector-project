    ...
    return (
        <div>
            ...
            <div className='flex flex-col items-center justify-center'>
                ...
                <button className='bg-violet-800 rounded-md w-24 hover:bg-violet-900 font-medium'>LogIn</button>
                <div className='flex flex-r mt-3 ' >
                    <p className='text-white opacity-70 m-1'>don't have an account?
                        <button className='text-violet-600 m-1' onClick={() => setActive(!active)}>Create here</button>
                    </p>
                </div>
            </div>
        </div>
